...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RPCNestedTests_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 30, 0)
    ...
    "RPCNestedTests\0rpcNestedTests\0\0"
};
...
const QMetaObject RPCNestedTests::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RPCNestedTests.data,
      qt_meta_data_RPCNestedTests,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RPCNestedTests.stringdata))
