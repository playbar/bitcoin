...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ModalOverlay_t, stringdata) + ofs \
...
QT_MOC_LITERAL(12, 139, 14)
    ...
    "userRequested\0closeClicked\0isLayerVisible\0"
};
...
const QMetaObject ModalOverlay::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ModalOverlay.data,
      qt_meta_data_ModalOverlay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ModalOverlay.stringdata))
