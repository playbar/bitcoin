...
ACLOCAL = ${SHELL} /mywork/github/bitcoin/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
...
CPPFLAGS =  -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -isystem /opt/local/include -I/usr/local/opt/berkeley-db@4/include -DMAC_OSX
...
LIBMEMENV = 
LIBOBJS = 
LIBS =  -L/opt/local/lib -L/usr/local/opt/berkeley-db@4/lib
...
MAINT = 
MAKEINFO = ${SHELL} /mywork/github/bitcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
PORT = port
PROTOBUF_CFLAGS = -D_THREAD_SAFE -I/usr/local/include
PROTOBUF_LIBS = -L/usr/local/lib -lprotobuf -D_THREAD_SAFE
PROTOC = /usr/local/bin/protoc
PTHREAD_CC = gcc
PTHREAD_CFLAGS = -pthread
PTHREAD_LIBS = 
PYTHON = /program/anaconda3/bin/python3.6
PYTHONPATH = 
...
X11XCB_CFLAGS = 
X11XCB_LIBS = 
XGETTEXT = /program/anaconda3/bin/xgettext
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /mywork/github/bitcoin
abs_srcdir = /mywork/github/bitcoin
abs_top_builddir = /mywork/github/bitcoin
abs_top_srcdir = /mywork/github/bitcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /mywork/github/bitcoin/build-aux/install-sh
