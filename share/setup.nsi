...
!define MUI_ICON "/mywork/github/bitcoin/share/pixmaps/bitcoin.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/mywork/github/bitcoin/share/pixmaps/nsis-wizard.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/mywork/github/bitcoin/share/pixmaps/nsis-header.bmp"
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/mywork/github/bitcoin/share/pixmaps/nsis-wizard.bmp"
...
OutFile /mywork/github/bitcoin/bitcoin-${VERSION}-win-setup.exe
!if "" == "64"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /mywork/github/bitcoin/release/bitcoin-qt
    File /oname=COPYING.txt /mywork/github/bitcoin/COPYING
    File /oname=readme.txt /mywork/github/bitcoin/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /mywork/github/bitcoin/release/bitcoind
    File /mywork/github/bitcoin/release/bitcoin-cli
    SetOutPath $INSTDIR\doc
    File /r /mywork/github/bitcoin/doc\*.*
    SetOutPath $INSTDIR
